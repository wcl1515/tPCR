...
%
% in
%	yi	[nx,ny]	noisy complex image: y = mag .* exp(1i * x)
%
% options
...
%	'pl'	1|0	use 1 for new PL method, 0 for old way
% out
%	x	[nx,ny]	cleaned up phase estimate
%	mask0	[nx,ny]	logical: 1 for high-magnitude pixels
%
...
%
% Copyright 1999, Jeff Fessler, The University of Michigan
