...
if (nargin <= 1) % run test routine
	...
	%temp = temp';
	%fld_write('/home/someshs/backup/data/EMC1.21411.4/integ_test_subvol/hct/expt_test/res121007/peaks.fld',temp);
	%im(temp,[800 1200])
	%imshow(temp',[800 1200])
	% a dcm viewer should show an image similar to the ones displayed above

	result = fld2dcm('/home/someshs/backup/data/EMC1.21411.4/integ_test_subvol/hct/expt_test/res121007/peaks.fld', ...
		'/tmp/peaks.dcm', 1000, 400);
	return
end
