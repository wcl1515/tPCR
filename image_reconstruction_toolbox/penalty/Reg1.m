...
otherwise
	error('bad penalty type "%s"', arg.type_penal)
end
...
arg.pot_params = cat(1, arg.pot_arg{1}{2:end});
...
tmp = sr.cgrad1_arg; % trick: strum limitation
...
[x ei] = embed_in(x, sr.mask);
tmp = sr.denom_sqs1_arg; % trick: strum limitation
