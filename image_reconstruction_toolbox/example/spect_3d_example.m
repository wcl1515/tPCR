...
%
% Copyright 2005-1-31, Jeff Fessler, The University of Michigan
...
if ~isvar('G'), printm 'G'
	...
	G = Gtomo3(f.sys_type, ig.mask, ig.nx, ig.ny, ig.nz, 'chat', 0);
	...
	G0 = Gtomo3(f.sys_type0, ig.mask, ig.nx, ig.ny, ig.nz, 'chat', 0);
prompt
end
