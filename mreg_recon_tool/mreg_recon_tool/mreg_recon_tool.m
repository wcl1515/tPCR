...
D.gui_data.temporal_recon_type_string = {'standard','sliding window','KWIC','tPCR_step1','tPCR_step2','tPCR_step3'};
...
H.tolerance_e = uicontrol(H.main_fig,'Style','Edit','Parent',H.recon_parameters_panel_1,'String','5e-4','Position',[spacing,p(2)-pb_height-tb_height-spacing,pb_width,pb_height],'BackgroundColor','white','Callback',{@tolerance_e_cb});
...
H.use_gridengine_cb = uicontrol(H.main_fig,'Style','CheckBox','Parent',H.recon_panel,'String','Use Slurm','Value',1,'Position',[spacing,p(2)-cb_height-spacing,cb_width,cb_height],'Callback',{@use_gridengine_cb_cb});
...
%%
D.recon.recon_details.EnableSlurm = get(H.use_gridengine_cb,'Value');
