function reference = resizeReference_T2s(reference, newFOV, newRes, mreg_header, sensmode)
...
reference.SENSEreco(reference.SENSEreco==0) = max(reference.SENSEreco(:))*1e-6;
tmp = log(permute(abs(reference.SENSEreco),[4 1 2 3]));
%n = 6;
